...
class PdfService {
  static Future<void> generateLabReportPdf(
    LabReport report,
  ...
  static Future<void> generateSummaryPdf(
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                    pw.Text(
                      report.labName,
                      style: pw.TextStyle(font: fontBoldData, fontSize: 12),
                    ),
                    pw.Text(
            ...
            pw.Text(
              'DISCLAIMER: This report is generated by LabSense AI for educational purposes only and should not be used as a substitute for professional medical advice, diagnosis, or treatment. Please review these results with your healthcare provider.',
              style: pw.TextStyle(
                fontSize: 8,
    ...
    await Printing.layoutPdf(
      onLayout: (PdfPageFormat format) async => pdf.save(),
      name:
          'Professional_Health_Summary_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
      ...
      children: [
        ...
        pw.Column(
          ...
          children: [
            ...
            pw.Text(
              'ID: LS-${DateFormat('yyyyMM').format(DateTime.now())}-${DateTime.now().millisecond}',
      ...
      children: [
        ...
        pw.Column(
          ...
          children: [
            ...
            pw.Text(
              'Report Date: ${DateFormat('MMM d, yyyy').format(report.date)}',
  ...
  static pw.Widget _buildResultsTable(
    ...
    return pw.TableHelper.fromTextArray(
      headers: headers,
      data: results
          .map((r) => [r.name, r.result, r.unit, r.reference, r.status])
          .toList(),
  ...
  static pw.Widget _buildFooter(pw.Font font) {
    return pw.Container(
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text(
            'LabSense AI - Advanced Health Insights',
            style: pw.TextStyle(
              font: font,
              fontSize: 8,
